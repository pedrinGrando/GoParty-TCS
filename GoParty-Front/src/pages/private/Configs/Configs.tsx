            ...
            <div className="flex items-center justify-center min-h-screen dark:bg-gray-900">
                <div className="w-full max-w-4xl mx-4 sm:mx-8 xl:mx-auto">
                    ...
                    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow dark:bg-gray-900">
                        <div className="pt-4">
                            <p className="font- text-slate-600">Realize alterações importantes em sua conta.</p>
                        </div>
                        <div className="pt-4">
                        ...
                        <p className="py-2 text-xl font-semibold">Endereço de E-mail</p>
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            <p className="text-gray-600">Seu E-mail é <strong>{user.email}</strong></p>
                        </div>
                        <hr className="mt-4 mb-8" />
                        <p className="py-2 text-xl font-semibold">Nome de usuário</p>
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                            {changeUsernameActive ? (
                                ...
                                <p className="text-gray-600">Seu nome de usuário é <strong>{user.username}</strong></p>
                            )}
                            {changeUsernameActive ? (
