              ...
              <tbody>
                {eventos.map((evento) => (
                  <tr key={evento.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <svg className="w-4 h-4 text-indigo-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
