                            ...
                            <div>
                                {notifications.length === 0 ? (
                                    ...
                                    <div className="flex justify-center my-8  dark:bg-gray-900">
                                        <div id="toast-notification" className="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg dark:bg-white dark:text-black" role="alert">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div className="ms-3 text-sm font-normal">
                                                    <div className="text-sm font-semibold text-gray-900 dark:text-white">Noti Teste</div>
                                                    <div className="text-sm font-normal">Noti Teste</div>
                                                    <span className="text-xs font-medium text-blue-600 dark:text-blue-500">Noti Teste</span>
                                                </div>
                                            </div>
                                            <hr className="my-5 border-gray-400 dark:bg-gray-900 dark:border-gray-300 lg:my-5" />
                                        </div>
