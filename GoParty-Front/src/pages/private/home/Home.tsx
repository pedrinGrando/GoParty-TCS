                    ...
                    {eventos.length === 0 ? (
                        ...
                        eventos.map(evento => (
                            <div className="max-w-sm mx-auto rounded overflow-hidden shadow-lg dark:shadow-lg">
                                    <a className="cursor-pointer mt-12 inline-flex justify-between shadow-md items-center py-1 px-1 pe-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
