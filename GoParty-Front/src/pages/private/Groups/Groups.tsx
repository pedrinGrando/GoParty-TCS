  ...
  interface UsuarioDTO {
    ...
    return (
        <div>
            ...
            <div className="max-w-4xl mx-auto"> {/* Alterado max-w-2xl para max-w-4xl */}
                <TrendEvents />
                <div className="p-4 max-w-3xl bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700 mt-10 ml-10"> {/* Alterado max-w-md para max-w-3xl */}
