...
export const NoEvent: React.FC = () => {
    ...
    return (
      <div>
        <section className="bg-center bg-no-repeat rounded-lg bg-blend-multiply py-24 lg:py-40">
            <div className="px-4 mx-auto text-center max-w-xl">
                ...
                <p className="mb-6 text-base text-black lg:text-lg sm:px-6 lg:px-12">Mas não se preocupe, você pode criar seu primeiro próprio evento e atrair o público correto para a busca de fundos necessários. Seja um GoParty Adm agora!</p>
