    ...
    <div>
      ...
      <div className="flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800 dark:bg-gray-700">
        <div className={`fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r transition-all duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`} style={{ zIndex: 999 }}> {/* Adicionando estilo zIndex */}
          ...
          <div className="overflow-y-auto overflow-x-hidden flex-grow dark:bg-gray-700">
            <ul className="flex flex-col py-4 space-y-1">
              ...
              <li>
                <Link to="/home">
                  <div className={location.pathname === '/home' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5" />
                      </svg>
                    </span>
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Home</span>
                  </div>
                </Link>
              </li>
              <li>
                <Link to="/explore">
                  <div className={location.pathname === '/explore' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />
                      </svg>
                    </span>
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Buscar</span>
              ...
              <li>
                <Link to='/your-notifications'>
                  <div className={location.pathname === '/your-notifications' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5.365V3m0 2.365a5.338 5.338 0 0 1 5.133 5.368v1.8c0 2.386 1.867 2.982 1.867 4.175 0 .593 0 1.292-.538 1.292H5.538C5 18 5 17.301 5 16.708c0-1.193 1.867-1.789 1.867-4.175v-1.8A5.338 5.338 0 0 1 12 5.365ZM8.733 18c.094.852.306 1.54.944 2.112a3.48 3.48 0 0 0 4.646 0c.638-.572 1.236-1.26 1.33-2.112h-6.92Z" />
                      </svg>
                    </span>
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Notificações</span>
                    {contadorNoti > 0 ?
              ...
              <li className="px-5">
                <div className="flex flex-row items-center h-8">
                  <div className="text-sm font-light tracking-wide dark:text-gray-400 text-gray-500">Eventos</div>
                </div>
              </li>
              {user?.tipoUsuario === 'MEMBER' && (
                <li>
                  <Link to='/create-event'>
                    <div className={location.pathname === '/register-adm' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6'}>
                      <span className="inline-flex justify-center items-center ml-4">
                      ...
                      <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Criar evento</span>
                    </div>
                  </Link>
                </li>
              )}
                ...
                <li>
                  <Link to='/your-graduation'>
                    <div className={location.pathname === '/register-adm' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6'}>
                      ...
                      <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Sua formatura</span>
                    </div>
                  </Link>
                </li>
              )}
              {user?.tipoUsuario === 'MEMBER' && (
                <li>
                  <Link to='/your-events'>
                    <div className={location.pathname === '/your-events' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6'}>
                      ...
                      <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Seus eventos </span>
                    </div>
                  </Link>
                </li>
              )}
                ...
                <li>
                  <Link to='/register-adm'>
                    <div className={location.pathname === '/register-adm' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                      ...
                      <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Ser GoParty ADM</span>
                    </div>
                  </Link>
                </li>
              )}
              <li>
                <Link to='/your-tickets'>
                  <div className={location.pathname === '/your-tickets' ? 'relative flex flex-row items-center h-11 focus:outline-none dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Ingressos</span>
                  </div>
                </Link>
              </li>
              {user?.tipoUsuario === 'MEMBER' && (
                <li>
                  <Link to='/your-groups'>
                    <div className={location.pathname === '/your-groups' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                      <span className="inline-flex justify-center items-center ml-4">
                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                          <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 17H4a1 1 0 0 1-1-1 3 3 0 0 1 3-3h1m0-3.05A2.5 2.5 0 1 1 9 5.5M19.5 17h.5a1 1 0 0 0 1-1 3 3 0 0 0-3-3h-1m0-3.05a2.5 2.5 0 1 0-2-4.45m.5 13.5h-7a1 1 0 0 1-1-1 3 3 0 0 1 3-3h3a3 3 0 0 1 3 3 1 1 0 0 1-1 1Zm-1-9.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Z" />
                        </svg>
                      </span>
                      <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Seu Grupo</span>
              ...
              <li>
                <Link to='/trending-events'>
                  <div className={location.pathname === '/trending-events' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    ...
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Em Alta</span>
                    <span className="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-green-500 bg-green-50 rounded-full">15</span>
                  </div>
                </Link>
              </li>
              <li className="px-5">
                <div className="flex flex-row items-center h-8">
                  <div className="text-sm font-light tracking-wide dark:text-gray-400 text-gray-500">Configurações</div>
                </div>
              </li>
              <li>
                <Link to='/your-profile'>
                  <div className={location.pathname === '/your-profile' ? 'relative flex flex-row items-center h-11 focus:outline-none dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-width="2" d="M7 17v1a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3Zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                      </svg>
                    </span>
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Perfil</span>
                  </div>
                </Link>
              </li>
              <li>
                <Link to='/account-config'>
                  <div className={location.pathname === '/account-config' ? 'relative flex flex-row items-center h-11 focus:outline-none  dark:bg-gray-800 bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent border-indigo-600 pr-6"' : 'relative flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray-800 hover:bg-gray-300 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6"'}>
                    <span className="inline-flex justify-center items-center ml-4">
                      <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="square" stroke-linejoin="round" stroke-width="2" d="M10 19H5a1 1 0 0 1-1-1v-1a3 3 0 0 1 3-3h2m10 1a3 3 0 0 1-3 3m3-3a3 3 0 0 0-3-3m3 3h1m-4 3a3 3 0 0 1-3-3m3 3v1m-3-4a3 3 0 0 1 3-3m-3 3h-1m4-3v-1m-2.121 1.879-.707-.707m5.656 5.656-.707-.707m-4.242 0-.707.707m5.656-5.656-.707.707M12 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                      </svg>
                    </span>
                    <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Configurações</span>
                  </div>
                </Link>
              </li>
              <li>
                ...
                <div onClick={handleLogout} className="relative flex flex-row items-center ml-3 h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 cursor-pointer">
                  ...
                  <span className="ml-2 text-sm tracking-wide dark:text-gray-400 truncate">Sair</span>
                </div>
              </li>
              <li>
                <footer className="shadow dark:bg-gray-800 rounded m-4">
        ...
        <button
          ...
          className="fixed p-1 text-black dark:text-white rounded-full top-3 left-2"
          style={{ zIndex: 999 }}
        >
          <svg
            className="w-6 h-6"
