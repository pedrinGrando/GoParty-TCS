        ...
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="flex flex-col items-center justify-center">
            <ul className="flex flex-row items-center justify-center space-x-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
              <li>
                <Link to="/home">
                  <div className={location.pathname === '/home' ? 'flex items-center h-11 text-indigo-500 border-l-4 pr-6' : 'flex items-center h-11 hover:text-indigo-500 border-l-4 pr-6'}>
              ...
              <li>
                <Link to="/explore">
                  <div className={location.pathname === '/explore' ? 'flex items-center h-11 text-indigo-500 border-l-4 pr-6' : 'flex items-center h-11 hover:text-indigo-500 border-l-4 pr-6'}>
              ...
              <li>
                <Link to='/your-profile'>
                  <div className={location.pathname === '/your-profile' ? 'flex items-center h-11 text-indigo-500 border-l-4 pr-6"' : 'flex items-center h-11 hover:text-indigo-500 border-l-4 pr-6"'}>
