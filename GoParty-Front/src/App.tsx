    ...
    <Router>
      <UserProvider>
        <Routes>
          ...
          <Route path='/your-graduation/ticket-report' element={isAuthenticated() ? <TicketReport /> : <Navigate to="/login" />} />
          <Route path='/your-graduation/event-report' element={isAuthenticated() ? <EventReport /> : <Navigate to="/login" />} />
