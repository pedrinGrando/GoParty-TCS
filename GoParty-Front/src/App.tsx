    ...
    <Router>
      <UserProvider>
        <Routes>
          ...
          <Route path='/your-graduation/tickets-report' element={isAuthenticated() ? <Graduation /> : <Navigate to="/login" />} />
          <Route path='/your-graduation/events-report' element={isAuthenticated() ? <Graduation /> : <Navigate to="/login" />} />
